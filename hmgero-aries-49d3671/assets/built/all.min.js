...
/* PrismJS 1.15.0
https://prismjs.com/download.html#themes=prism-okaidia&languages=markup+css+clike+javascript+csharp+aspnet+docker+markup-templating+git+http+java+json+markdown+nginx+php+sql+python+swift&plugins=line-numbers */
